...
export default function LoginForm({ isDemo }: { isDemo: boolean }) {
      ...
      <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-md">
        {isDemo && (
          <div className="mb-6 rounded-lg border border-orange-200 bg-orange-50 p-4 text-sm">
            ...
            <div className="space-y-1 font-mono text-orange-700">
              <div>Admin &nbsp;&nbsp;&nbsp;→ <strong>demo-admin</strong> / <strong>demo1234</strong></div>
              <div>Marshal → select group, passcode shown on next screen</div>
            </div>
          </div>
        )}
        ...
        <div className="mb-6 text-center">
          <h1 className="text-2xl font-bold text-gray-900">
            {isDemo ? "SuperSats" : "TSK Participation & Performance"}
          </h1>
          <p className="mt-1 text-sm text-gray-500">
            {isDemo ? "Live Demo Environment" : "Participation & Performance Management"}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              type="text"
              required
              defaultValue={isDemo ? "demo-admin" : undefined}
