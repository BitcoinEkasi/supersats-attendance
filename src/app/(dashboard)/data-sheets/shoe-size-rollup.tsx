...
export default function ShoeSizeRollup({ rollup }: { rollup: ShoeRollup }) {
  const thCls = "px-3 py-2 text-right font-medium text-gray-500 border-b whitespace-nowrap";

  return (
    <div className="rounded-lg border border-gray-200 bg-white overflow-hidden">
      <div className="border-b px-4 py-3 flex items-center justify-between">
        <p className="text-xs text-gray-500">Active participants per group, by shoe size — for placing shoe orders.</p>
        <ShoeRollupExportButtons />
      </div>
